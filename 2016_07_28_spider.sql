...
CREATE TABLE `answer` (
  ...
  `upvote` varchar(80) NOT NULL,
  `content` text NOT NULL,
  `dataAid` varchar(80) NOT NULL,
  `urlToken` varchar(80) NOT NULL,
  `startUpvoteUserUrl` varchar(80) NOT NULL,
...
CREATE TABLE `user` (
  ...
  PRIMARY KEY (`userId`)
) ENGINE=InnoDB AUTO_INCREMENT=91963 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-07-28 17:50:56
